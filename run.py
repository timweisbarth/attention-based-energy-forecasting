...
def main():
    ...
    parser.add_argument('--model_id', type=str, required=True, default='test', help='Describe target for univariate case (used for folder structure)')
    parser.add_argument('--model', type=str, required=True, default='Autoformer',
                        help='model name, options: [LSTM, Autoformer, Informer, Transformer]')
    ...
    parser.add_argument('--e_layers', type=float, default=2, help='num of encoder layers')
    ...
    parser.add_argument('--lradj', type=str, default='type1', help='adjust learning rate') # Caution type3 for PatchTST
